      ...
      <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
        ...
        <div className="flex-1 space-y-5">
          ...
          <div className="flex gap-5 items-center">
            ...
            <div className="relative ml-10 rounded-lg border py-1 px-1 border-pink-300 bg-pink-300 text-black font-semibold">
          ...
          <ul className="space-y-2 ml-2 my-7">
            {product.features.map((feature) => (
              <li
                key={feature}
                className="text-s flex-items-center gap-2 -tracking-tight font-medium"
              >
              ...
              {availableColors.map((color) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-full flex justify-center items-center ${
                    selectedColor === color ? "border border-pink-300" : ""
                  }`}
          ...
          <div className="flex pt-2">
            ...
            <Link
              to="#"
              className="flex flex-col gap-1 flex-1 items-center justify-center hover:text-green-400"
            >
