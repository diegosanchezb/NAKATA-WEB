  ...
  return (
    <div className="text-black">
      <div className="flex justify-between items-center">
        <button
          className="border rounded-full py-2 border-black bg-pink-300 hover:bg-green-400 cursor-pointer px-5 flex items-center justify-center gap-2 text-xs font-medium uppercase tracking-widest transition-all"
          onClick={() => navigate(-1)}
        >
