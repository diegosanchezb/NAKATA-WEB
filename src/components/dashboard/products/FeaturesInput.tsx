...
export const FeaturesInput = ({ control, errors }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-2">
        ...
        {fields.map((field, index) => (
          ...
          >
            <div className="flex items-center gap-2">
              <div className="bg-pink-300 h-2 w-2 rounded-full" />
      ...
      <input
        type="text"
        placeholder="256 de almacenamiento"
        className={`border border-pink-300 py-1.5 text-sm rounded-md px-3 font-medium tracking-tighter text-black outline-none focus:outline-none ${
